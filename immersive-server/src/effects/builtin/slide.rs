...
impl EffectDefinition for SlideDefinition {
    ...
    fn default_parameters(&self) -> Vec<Parameter> {
        vec![
            ...
            Parameter::new(ParameterMeta::enumeration(
                "wrap_mode",
                "Wrap Mode",
                vec!["Clamp".into(), "Repeat".into(), "Mirror".into()],
                0,
            )),
        ]
    }
    ...
    fn create_gpu_runtime(
        ...
        Some(Box::new(SlideRuntime::new(device, output_format)))
    }
...
impl SlideRuntime {
    /// Create a new slide runtime
    pub fn new(device: &wgpu::Device, output_format: wgpu::TextureFormat) -> Self {
        let shader_source = include_str!("../../shaders/effects/slide.wgsl");
        ...
        let bind_group_layout = device.create_bind_group_layout(&wgpu::BindGroupLayoutDescriptor {
            label: Some("Slide Bind Group Layout"),
            entries: &[
                // Input texture
        ...
        // Layout: time, delta_time, beat_phase, bar_phase, offset_x, offset_y, wrap_mode, _pad
        // Total: 8 floats = 32 bytes
        let params_buffer = device.create_buffer(&wgpu::BufferDescriptor {
            label: Some("Slide Params Buffer"),
            size: 32,
...
impl GpuEffectRuntime for SlideRuntime {
    fn process(
        &mut self,
        ...
        // [time, delta_time, beat_phase, bar_phase, offset_x, offset_y, wrap_mode, pad]
        let uniform_data: [f32; 8] = [
            params.time,
            params.delta_time,
            params.beat_phase,
            params.bar_phase,
            params.params[0], // offset_x
            params.params[1], // offset_y
            params.params[2], // wrap_mode
            0.0,              // padding
        ];
