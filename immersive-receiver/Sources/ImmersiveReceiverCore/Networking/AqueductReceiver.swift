...
public final class AqueductReceiver: @unchecked Sendable {
    ...
    private let logger = Logger(subsystem: "com.immersive.receiver", category: "AqueductReceiver")
    private let receiveQueue = DispatchQueue(label: "com.immersive.receiver.receive", qos: .userInteractive)
